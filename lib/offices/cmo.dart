...
import 'package:request_information/offices/view_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
        ...
        "offices/view_page": (BuildContext context)=> ViewJob(),
        },
        home: Scaffold(
      ...
      child: Padding(
        ...
        child: ListView(
          children: <Widget>[
            Card(
              child: InkWell(
                onTap: (){Navigator.pushNamed(context, "offices/view_page");},
                child: Column(
                  children: <Widget>[
                    Padding(
